...
//                                                                       //
// Multi-site modifications by Greg Lund-Chaix  http://osuosl.org        // 
//                                                                       //
...
//=========================================================================
// 0.1 Multi-host config
//=========================================================================
//
// Stuff to make Moodle able to so shared-code hosting of multiple domins
//
// Determine hostname
...
if (isset($sites_array['prefix'])) {
	$CFG->prefix	= $sites_array['prefix'];
} else {
...
// Commented out, as dirroot is already set above.
//$CFG->dirroot   = '/var/www/moodle/htdocs';
...
//$CFG->dataroot  = '/var/www/moodle/moodledata/'.$hostname;
$CFG->dataroot   = $sites_array['dataroot'];
...
//
//     $CFG->emailconnectionerrorsto = 'webmaster-pager@example.com';
// 
